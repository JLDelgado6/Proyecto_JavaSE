	...
	private static void ejecutarOpcion(int opcion) {
		...
		switch(opcion) {
	    	case 1: 
			    ...
			    if (d1<2 || d1>7) {System.out.println("XXX El Número de Puertas no es correcto XXX");break;}
			...
			case 2: 
			    ...
			    if (e2 < 1 || e2 > 4) {System.out.println("XXX El Número de Ejes no es correcto XXX");break;}
			...
			case 3: 
			    ...
			    if (b3 < 0 || b3 > 1000) {System.out.println("XXX La Altura Máxima de Vuelo no es correcta XXX");break;}
			    Integer c3 = utiles.LecturaTeclado.lecturaEntero("- Kilometro de Autonomía (km) ");
			    if (c3 < 0 || c3 > 10000000) {System.out.println("XXX El kilometro de Autonomía no es correcto XXX");break;}
			...
			case 4: 
			    ...
			    if (b4 < 0 || b4 > 12800) {System.out.println("XXX La Altura Máxima de Vuelo no es correcta XXX");break;}
			    Integer c4 = utiles.LecturaTeclado.lecturaEntero("- Kilometro de Autonomía ");
			    if (c4 < 0) {System.out.println("XXX El kilometro de Autonomía no es correcto XXX");break;}
			    Integer d4 = utiles.LecturaTeclado.lecturaEntero("- Máximo Número de Pasajeros:  ");
			    if (d4 < 5 || d4 > 550) {System.out.println("XXX El Máximo Número de Pasajeros no es correcto XXX");break;}
